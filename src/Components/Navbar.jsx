      ...
      {isOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <a href="#home" onClick={() => setIsOpen(!isOpen)} className="block px-3 py-2 text-white hover:text-indigo-600">Home</a>
            <a href="#portfolio" onClick={() => setIsOpen(!isOpen)} className="block px-3 py-2 text-white hover:text-indigo-600">Portfolio</a>
            <a href="#about" onClick={() => setIsOpen(!isOpen)} className="block px-3 py-2 text-white hover:text-indigo-600">About</a>
            <a href="#services" onClick={() => setIsOpen(!isOpen)} className="block px-3 py-2 text-white hover:text-indigo-600">Services</a>
            <a href="#testimonials" onClick={() => setIsOpen(!isOpen)} className="block px-3 py-2 text-white hover:text-indigo-600">Testimonials</a>
            <a href="#contact" onClick={() => setIsOpen(!isOpen)} className="block px-3 py-2 bg-red-600 text-white rounded-md">Contact</a>
          </div>
        </div>
      )}
    </nav>
